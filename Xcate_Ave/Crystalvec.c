...
***********************************************************************************************************/
void Crystalvec(int N,int m,double*halfL,int**Nblist,double**ArrR,double**LocVecq4R,double**LocVecq4I,double**LocVecq6R,double**LocVecq6I,double*eigenvalue,double**matric,double**Xcate){
	int i,j,lt1;
	...
	Cal_VecQ(N,m,Nblist,NArrR,LocVecq4R,LocVecq4I,LocVecq6R,LocVecq6I,halfL,Rmatrix);
